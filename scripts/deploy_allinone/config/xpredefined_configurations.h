...
XDECLARE_ONCHAIN_GOVERNANCE_PARAMETER(min_mainnet_active_auditors, std::uint32_t, normal, 0, 0, std::numeric_limits<std::uint32_t>::max());
XDECLARE_ONCHAIN_GOVERNANCE_PARAMETER(min_mainnet_active_validators, std::uint32_t, normal, 0, 0, std::numeric_limits<std::uint32_t>::max());
...
XDECLARE_ONCHAIN_GOVERNANCE_PARAMETER(min_mainnet_active_edges, std::uint32_t, normal, 0, 0, std::numeric_limits<std::uint32_t>::max());
XDECLARE_ONCHAIN_GOVERNANCE_PARAMETER(min_mainnet_active_archives, std::uint32_t, normal, 0, 0, std::numeric_limits<std::uint32_t>::max());
// vote:
...
XDECLARE_CONFIGURATION(platform_public_endpoints,
                       char const *,
                       "127.0.0.1:9001,127.0.0.2:9002,127.0.0.3:9003,127.0.0.4:9004,127.0.0.5:9005,127.0.0.6:9006");
XDECLARE_CONFIGURATION(platform_url_endpoints, char const *, "http://unnecessary.org");
